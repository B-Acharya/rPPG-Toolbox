...
class rPPGNetTrainer(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        skin_map, rPPG_aux, rPPG, rPPG_SA1, rPPG_SA2, rPPG_SA3, rPPG_SA4, x_visual6464, x_visual3232 = self.model(
            batch[0][:, 0:3, :, :, :].to(torch.float32).to(self.device))
    ...
    def test_step(self, batch, batch_idx):
        ...
        skin_map, rPPG_aux, pred_ppg_test, rPPG_SA1, rPPG_SA2, rPPG_SA3, rPPG_SA4, x_visual6464, x_visual3232 = self.model(
            data[:, 0:3, :, :, :].to(torch.float32).to(self.device))
