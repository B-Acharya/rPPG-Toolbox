...
from rPPG_Toolbox.dataset.data_loader.face_detector.utils.common import (
    Conv,
    Bottleneck,
    SPP,
    DWConv,
...
from rPPG_Toolbox.dataset.data_loader.face_detector.utils.experimental import (
    MixConv2d,
    CrossConv,
)
from rPPG_Toolbox.dataset.data_loader.face_detector.utils.data_ops import (
    check_anchor_order,
    make_divisible,
)
from rPPG_Toolbox.dataset.data_loader.face_detector.utils.general import (
    check_file,
    set_logging,
)
from rPPG_Toolbox.dataset.data_loader.face_detector.utils.torch_utils import (
    time_synchronized,
    fuse_conv_and_bn,
    model_info,
    scale_img,
...
class Model(nn.Module):
    def __init__(
        self,
        cfg="./dataset/data_loader/face_detector/model/yolo5face.yaml",
        ch=3,
        nc=None,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cfg",
        type=str,
        default="./dataset/data_loader/face_detector/model/yolo5face.yaml",
        help="model.yaml",
    )
    parser.add_argument(
