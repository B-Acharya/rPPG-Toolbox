...
from rPPG_Toolbox.unsupervised_methods.methods import POS_WANG, CHROME_DEHAAN
...
class BaseLoader(Dataset):
    ...
    def generate_chrom_pseudo_labels(self, frames, fs=30):
        LPF = 0.7
        HPF = 2.5
        WinSec = 1.6

        RGB = CHROME_DEHAAN.process_video(frames)
        FN = RGB.shape[0]
        NyquistF = 1 / 2 * fs
